...
The context-free grammar for the language is given below:
\\\textbf{GRAMMAR GOES HERE}
...
\begin{tabular}{ l l l l l }
    ...
    >               & Greater-than  & \texttt{Int -> Int -> Bool}   & \texttt{3 > 4}    & \texttt{true} \\
\end{tabular}

...
\end{itemize}
Template instantiation was chosen as the implementation due to time constraints. Implementing template instantiation is simpler than conventional compilation via closure conversion - closure conversion is...
